...
<head>
    ...
    <base href="http://localhost/imran/oop_project/lab_test/">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="view/admin/product/create.php">Add Product</a>
                                </li>
                                <li>
                                    <a href="view/admin/product/index.php">View Product</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
